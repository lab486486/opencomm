...
# WordPress behavior
INSTRUCTION_CATEGORY = os.getenv("INSTRUCTION_CATEGORY", "드라마_지시")
OUTPUT_CATEGORY = os.getenv("OUTPUT_CATEGORY", "드라마 정보")
...
PUBLISH_STATUS = os.getenv("PUBLISH_STATUS", "publish")
...
LOG_FILE = str(BASE_DIR / "drama_auto_post.log")
